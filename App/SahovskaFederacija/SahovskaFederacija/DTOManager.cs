    ...
    public class DTOManager
    {
        ...
        public static void dodajOrganizatoraTurnira(int idtur, int idorg)
        {
            try
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show(o.Ime + " je vec organizator turnira: " + t.Naziv);
                    s.Close();
                    return;
                }
                ...
                s.Flush();
                s.Close();
                System.Windows.Forms.MessageBox.Show("Organizator turnira uspesno dodat!");
            }
            catch (Exception ec)
            {
                System.Windows.Forms.MessageBox.Show(ec.Message);
        ...
        public static void dodajPartijuTurnira(int idTur, PartijaPregled part, int idBeli, int idCrni, bool isMajstor, int idS)
        {
            try
            {
                ...
                s.Close();
                System.Windows.Forms.MessageBox.Show("Partija dodata!");
            }
            catch (Exception ec)
            {
                System.Windows.Forms.MessageBox.Show(ec.Message);
        ...
        public static void izmeniPartijuTurnira(int idTur, PartijaPregled part, int idBeli, int idCrni, bool isMajstor, int idS)
        {
            try
            {
                ...
                s.Close();
                System.Windows.Forms.MessageBox.Show("Partija izmenjena!");
            }
            catch (Exception ec)
            {
                System.Windows.Forms.MessageBox.Show(ec.Message);
        ...
        public static void obrisiPartiju(int id)
        {
            try
            {
                ...
                s.Flush();
                s.Close();
                System.Windows.Forms.MessageBox.Show("Brisanje partije je uspesno obavljeno!");
            }
            catch (Exception ec)
            {
                System.Windows.Forms.MessageBox.Show(ec.Message);
